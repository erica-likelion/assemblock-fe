...
const ProfileSVG: React.FC<ProfileSVGProps> = ({ viewBox, children, width = '130px', height = '130px' }) => (
  <svg
    viewBox={viewBox}
    fill="none"
...
export const getProfileSVG = (profile: ProfileData, isSelected: boolean, size: 'small' | 'medium' | 'large' = 'large') => {
  if (!profile.colorMap) {
    return null;
  }
  ...
  // img1: circle + path (viewBox 130x130)
  if (profile.id === 'img1') {
    return (
  ...
  // img2: circle + path (viewBox 130x130)
  if (profile.id === 'img2') {
    return (
      <ProfileSVG viewBox="0 0 130 130" width={dimensions.width} height={dimensions.height}>
        <circle cx="64.8" cy="64.8" r="64.8" fill={bgColor} />
  ...
  // img3: circle + rect (viewBox 48x48)
  if (profile.id === 'img3') {
    return (
  ...
  // img4: circle + path (viewBox 130x130)
  if (profile.id === 'img4') {
    return (
      <ProfileSVG viewBox="0 0 130 130" width={dimensions.width} height={dimensions.height}>
        <circle cx="64.8" cy="64.8" r="64.8" fill={bgColor} />
  ...
  // img5: circle + rect (viewBox 130x130)
  if (profile.id === 'img5') {
    return (
      <ProfileSVG viewBox="0 0 130 130" width={dimensions.width} height={dimensions.height}>
        <circle cx="64.8" cy="64.8" r="64.8" fill={bgColor} />
